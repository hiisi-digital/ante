...
> **This is a snapshot, not a live matrix.** It was generated by a CI workflow that has since been
> removed, so nothing updates it any more and the results below describe the tree as it stood on the
> date at the foot of this file. Re-run the compatibility suite locally before relying on a row.
...
_Measured 2025-12-12. Not updated since; the workflow that produced it no longer exists._
